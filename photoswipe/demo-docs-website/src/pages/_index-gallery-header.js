...
export function GalleryExample(props) {
  ...
  return (
    <div className="gallery-row-example" id={props.id} data-summ={aspectRatioSumm}>
      {galleryItems}
    </div>
  );
}
...
export default function GalleryHeader() {
  ...
  return (
    <div className="gallery-row" id="gallery--header-home">
      ...
      <GalleryItem {...imagesData[4]}
        ...
        cropped={true}
        sizes="(min-width: 1124px) 393px, 35vw" />
      <div className='gallery-row-credit'>Photos by Luca Bravo</div>
    </div>
  );
}
