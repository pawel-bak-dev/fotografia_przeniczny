...
/**
 * @template.html {keyof HTMLElementTagNameMap} T
...
/**
 * @template.html {keyof KeyboardKeyCodesMap} T
 * @param {T} key
...
/**
 * @template.html {keyof PhotoSwipeFiltersMap} T
 * @typedef {{ fn: PhotoSwipeFiltersMap[T], priority: number }} Filter
 */

/**
 * @template.html {keyof PhotoSwipeEventsMap} T
